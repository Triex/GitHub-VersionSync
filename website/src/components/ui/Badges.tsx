...
export function Badges({ className = '' }: BadgeProps) {
  return (
    <div className={`flex flex-wrap justify-center gap-2 ${className}`}>
      ...
      {/* Repository Badges */}
      <Link 
        href="https://github.com/Triex/GitHub-Version-Sync/stargazers"
        target="_blank"
        className="transition-transform hover:scale-105"
      >
        <Image 
          src="https://img.shields.io/github/stars/Triex/GitHub-Version-Sync?style=flat-square&logo=github" 
          alt="GitHub Stars" 
          width={100} 
          height={20} 
        />
      ...
      >
        <Image 
          src="https://img.shields.io/github/release-date/Triex/GitHub-Version-Sync?style=flat-square&logo=github" 
